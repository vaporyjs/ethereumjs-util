...
const vapUtils = require('../index.js')
...
describe('sha3-512', function () {
  it('should produce a sha3', function () {
    ...
    const hash = vapUtils.sha3(msg, 512)
    assert.equal(hash.toString('hex'), r)
  })
})
...
describe('privateToPublic', function () {
  it('should produce a public key given a private key', function () {
    const pubKey = '3a443d8381a6798a70c6ff9304bdc8cb0163c23211d11628fae52ef9e0dca11a001cf066d56a8156fc201cd5df8a36ef694eecd258903fca7086c1fae7441e1d'
    const privateKey = Buffer.alloc([234, 84, 189, 197, 45, 22, 63, 136, 201, 58, 176, 97, 87, 130, 207, 113, 138, 46, 251, 158, 81, 167, 152, 154, 171, 27, 8, 6, 126, 156, 28, 95])
  ...
  it('shouldn\'t produce a public key given an invalid private key', function () {
    const privateKey1 = Buffer.alloc([234, 84, 189, 197, 45, 22, 63, 136, 201, 58, 176, 97, 87, 130, 207, 113, 138, 46, 251, 158, 81, 167, 152, 154, 171, 27, 8, 6, 126, 156, 28, 95, 42])
    const privateKey2 = Buffer.alloc([234, 84, 189, 197, 45, 22, 63, 136, 201, 58, 176, 97, 87, 130, 207, 113, 138, 46, 251, 158, 81, 167, 152, 154, 171, 27, 8, 6, 126, 156, 28])
    assert.throws(function () {
...
describe('isPrecompiled', function () {
  ...
  it('should return false', function () {
    ...
    assert.equal(vapUtils.isPrecompiled('0000000000000000000000000000000000000005'), false)
...
describe('baToJSON', function () {
  it('should turn a array of buffers into a pure json object', function () {
    const ba = [Buffer.alloc([0]), Buffer.alloc([1]), [Buffer.alloc([2])]]
